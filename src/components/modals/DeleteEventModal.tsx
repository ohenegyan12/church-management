...
const DeleteEventModal: React.FC<DeleteEventModalProps> = ({ isOpen, onClose, event, onConfirm }) => {
          ...
          <div className="bg-muted rounded-lg p-4 mb-6">
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div>
                ...
                <span className="ml-2 text-foreground">{event.date}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Location:</span>
                <span className="ml-2 text-foreground">{event.location}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Type:</span>
                <span className="ml-2 text-foreground">{event.type}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Attendees:</span>
                <span className="ml-2 text-foreground">{event.attendees.toLocaleString()}</span>
              </div>
            </div>
          </div>
