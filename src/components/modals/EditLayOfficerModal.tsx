...
interface EditLayOfficerModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (officer: any) => void;
  officer: any;
}

const EditLayOfficerModal: React.FC<EditLayOfficerModalProps> = ({ isOpen, onClose, onSave, officer }) => {
