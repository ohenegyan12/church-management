      ...
      <div className="relative bg-card rounded-xl shadow-xl w-full max-w-md mx-4 animate-scale-in">
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-foreground font-display">Add New Member</h2>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <FloatInput label="First Name" placeholder="John" required />
            <FloatInput label="Last Name" placeholder="Doe" required />
          </div>
          <FloatInput label="Email Address" type="email" placeholder="john@example.com" required />
          <FloatInput label="Phone Number" placeholder="+233 24 000 0000" />
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">Member Type</label>
          ...
          <div>
            ...
            <select className="w-full px-4 py-2.5 rounded-lg border border-border bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary">
              ...
              <option>Zion AME Church Osu</option>
              <option>Wesley AME Church Tema</option>
              <option>Trinity AME Church Kumasi</option>
            </select>
          </div>
